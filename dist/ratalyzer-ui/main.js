...
/* harmony import */ var _assets_animations_animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/animations/animations */ "./src/assets/animations/animations.ts");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _helpers_chart_options__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/chart-options */ "./src/helpers/chart-options.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.startSubscriptions = function () {
        var _this = this;
        this.connectedSubscription = this.socketService.connected.subscribe(function (connected) {
    ...
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            animations: [_assets_animations_animations__WEBPACK_IMPORTED_MODULE_1__["Animations"].fadeIn]
        }),
        __metadata("design:paramtypes", [_services_socket_service__WEBPACK_IMPORTED_MODULE_4__["SocketService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var Animations = {
    fadeIn: Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["trigger"])('simpleFadeAnimation', [
        ...
        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["transition"])(':leave', Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["animate"])(1000, Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__["style"])({ opacity: 0 })))
    ])
};
...
/***/ "./src/helpers/chart-options.ts":
/*!**************************************!*\
  !*** ./src/helpers/chart-options.ts ***!
  \**************************************/
/*! exports provided: ChartOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SocketService = /** @class */ (function () {
    function SocketService() {
        ...
        this._fileName = '';
        this._testing = false;
        this.connected = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"](1);
        this.count = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"](1);
        this.fileName = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"](1);
        this.testing = new rxjs__WEBPACK_IMPORTED_MODULE_1__["ReplaySubject"](1);
        this.onInit();
    }
    ...
    SocketService.prototype.start = function (ratName) {
        this.socket.emit('start', ratName);
    };
    SocketService.prototype.stop = function () {
...
module.exports = __webpack_require__(/*! /home/joshua/ratalyzer-ui/src/main.ts */"./src/main.ts");
